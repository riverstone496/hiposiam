...
def main(args):
    ...
    optimizer = get_optimizer(
        args.eval_optimizer, classifier, 
    ...
    lr_scheduler = LR_Scheduler(
        optimizer,
        args.eval_warmup_epochs, args.eval_warmup_lr*args.eval_batch_size/256, 
        args.eval_num_epochs, args.eval_base_lr*args.eval_batch_size/256, args.eval_final_lr*args.eval_batch_size/256, 
        len(train_loader),
    )
